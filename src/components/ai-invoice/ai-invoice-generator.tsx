    ...
    <div className="mx-auto max-w-3xl space-y-6 pb-12">
      ...
      {session?.analysisSummary && (
        ...
        <div className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-3 text-xs leading-relaxed text-amber-200">
          ...
          <button onClick={generate} disabled={!!loading || !accepted} className="dm-cta w-full gap-2 disabled:opacity-50">
      ...
      {successOutput && (
        <section className="rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-4 space-y-3">
