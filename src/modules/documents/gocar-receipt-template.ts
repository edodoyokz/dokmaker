...
export const GOCAR_RECEIPT_HTML_TEMPLATE = `<style>
  ...
  .gocar-total-val {
    font-size: 17px;
    font-weight: 700;
    color: #00880d;            /* brand green for emphasis value */
  }
          ...
          <div class="gocar-trip-left">
            ...
            <div class="gocar-trip-driver">
              <div class="gocar-driver-avatar">
                <!-- Steering wheel icon -->
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 22px; height: 22px; color: #00880d;">
            ...
            <div style="display: flex; align-items: center; margin-top: 12px; font-size: 12px; color: #000000;">
              <!-- Location pin icon -->
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 16px; height: 16px; color: #00880d; margin-right: 6px; flex-shrink: 0;">
              ...
              <div class="gocar-timeline-item">
                <div class="gocar-timeline-icon">
                  ...
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 20px; height: 20px;">
                    <circle cx="10" cy="10" r="9" fill="#00880d"/>
      ...
      <div class="gocar-footer">
        ...
        <div class="gocar-social-container">
          <span class="gocar-social-icon" aria-label="Instagram">
            <svg viewBox="0 0 24 24" fill="url(#instagramGrad)" style="width: 24px; height: 24px;">
              <defs>
          ...
          <span class="gocar-social-icon" aria-label="Facebook">
            <svg viewBox="0 0 24 24" fill="#1877F2" style="width: 24px; height: 24px;">
              <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.75z"/>
            </svg>
          </span>
          <span class="gocar-social-icon" aria-label="YouTube">
            <svg viewBox="0 0 24 24" fill="#FF0000" style="width: 24px; height: 24px;">
          ...
          <span class="gocar-social-icon" aria-label="LinkedIn">
            <svg viewBox="0 0 24 24" fill="#0A66C2" style="width: 22px; height: 22px;">
        ...
        <div style="display: flex; align-items: center; justify-content: center; margin: 12px 0 4px;">
          <!-- Gojek Ring Logo -->
          <svg viewBox="0 0 24 24" fill="#00880d" style="width: 26px; height: 26px; margin-right: 5px;">
